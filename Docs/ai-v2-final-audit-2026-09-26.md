...
снапшоту. Нарушений не найдено. Единственный «информационный» дефект — не кеш, а семантика
данных в снапшоте (F1: cheat-контакт без ETA трактовался как немедленная угроза).
