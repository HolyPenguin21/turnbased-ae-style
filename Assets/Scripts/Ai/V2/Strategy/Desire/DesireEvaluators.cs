...
namespace Game.Ai.V2
{
    ...
    public static class RadarValueScale
    {
        ...
        public static float For(Radar radar, MissionProposal m)
        {
            ...
            // Missing contributions do not silently impersonate Recon.
            // Explicit contributing axes with zero Radar still have zero priority.
            ...
            return wsum > 0f ? acc / wsum : 1f; // no valid contribution => neutral
        }
    }
}
