...
namespace Game.Styles
{
    ...
    public class FogOfWarStyle
    {
        ...
        [Range(0f, 1f)] public float edgeSoftness = 1f;
        ...
        [Range(0f, 1f)] public float edgeSharpness = 0.4f;
        public float edgeNoiseScale = 0.1f;
        public float edgeNoiseSpeed = 0.01f;
        ...
        [Range(0f, 1f)] public float detailTextureStrength = 1f;
