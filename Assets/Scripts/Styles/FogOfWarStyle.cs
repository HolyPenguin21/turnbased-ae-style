...
namespace Game.Styles
{
    ...
    public class FogOfWarStyle
    {
        ...
        public Color color = new Color(0.32f, 0.24f, 0.14f, 0.62f);
        ...
        [Range(0f, 1f)] public float edgeSharpness = 0.65f;
        public float edgeNoiseScale = 0.18f;
        public float edgeNoiseSpeed = 0.055f;
        ...
        [Range(0f, 1f)] public float detailTextureStrength = 0.38f;
